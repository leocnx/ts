package top.auok.cbps.ts.permission.controller;
...
import top.auok.cbps.ts.controller.common.BaseController;
import top.auok.cbps.ts.permission.biz.PmsMenuBiz;
import top.auok.cbps.ts.permission.entity.PmsOperator;
import top.auok.cbps.ts.permission.entity.PmsPermission;
import top.auok.cbps.ts.permission.entity.PmsRole;
import top.auok.cbps.ts.permission.enums.OperatorTypeEnum;
import top.auok.cbps.ts.permission.service.PmsMenuRoleService;
import top.auok.cbps.ts.permission.service.PmsMenuService;
import top.auok.cbps.ts.permission.service.PmsOperatorRoleService;
import top.auok.cbps.ts.permission.service.PmsPermissionService;
import top.auok.cbps.ts.permission.service.PmsRolePermissionService;
import top.auok.cbps.ts.permission.service.PmsRoleService;
import top.auok.cbps.ts.permission.utils.ValidateUtils;
